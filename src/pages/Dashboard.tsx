...
const Dashboard: React.FC<DashboardProps> = ({ children }) => {
  return (
    <div className="flex items-start justify-start w-[100%] h-[100vh] overflow-hidden">
      <aside className="w-[12%] md:w-[25%] rounded-sm md:rounded-tr-2xl rounded-br-2xl border-[2px] border-[#d1d5db] h-[100vh] py-[25px] md:py-[52px] overflow-auto">
        <Link
          href={`/`}
          className="flex items-center justify-start font-[700] text-[24px] leading-[24px] gap-0 md:gap-[24px] mb-[70px] px-[10px] md:px-[20px] transition-colors duration-300 ease-in-out"
        >
          <Image
            src={Logo}
            alt="Logo"
        ...
        <ul className="flex flex-col items-start w-[100%] font-Poppins">
          <Link
            href=""
            className="group flex items-center gap-0 md:gap-[15px] font-[600] text-[20px] leading-[30px] text-[#666666] h-[66px] md:h-[86px] w-[100%] px-[15px] md:px-[42px] hover:bg-[#be123d10] hover:text-[#be123c] hover:border-r-[3px] md:hover:border-r-[6px] hover:border-[#be123c] transition-colors duration-300 ease-in-out"
          >
          ...
          <Link
            href=""
            className="group flex items-center gap-0 md:gap-[15px] font-[600] text-[20px] leading-[30px] h-[66px] md:h-[86px] w-[100%] active:bg-[#be123daa] bg-[#be123d10] text-[#be123c] px-[15px] md:px-[42px] border-r-[3px] md:border-r-[6px] border-[#be123c] transition-colors duration-300 ease-in-out"
          >
          ...
          <Link
            href=""
            className="group flex items-center gap-[15px] font-[600] text-[20px] leading-[30px] text-[#666666] h-[66px] md:h-[86px] w-[100%] px-[15px] md:px-[42px] mt-[300%] md:mt-[24px]  hover:bg-[#be123d10] hover:text-[#be123c] hover:border-r-[3px] md:hover:border-r-[6px] hover:border-[#be123c] transition-colors duration-300 ease-in-out"
          >
      ...
      <main className="w-[88%] md:w-[75%] min-h-[100vh] py-[20px] px-[20px] md:py-[38px] md:px-[37px]">
        {children}
      </main>
    </div>
  );
